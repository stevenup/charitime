class Admin::AuthenticatedController < ApplicationController
  ...
  # Redirect to the specific path according to the admin authentication.
  ...
  # Reset the browser cache in case that the unauthenticated admin return back to the
  # previous authenticated pages.
